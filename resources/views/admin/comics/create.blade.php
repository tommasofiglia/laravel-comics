  ...
  <div class="container">
    ...
    <form action="{{route('admin.comics.store')}}" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <input id="title" name="title" type="text" placeholder="Titolo qui" class="d-block" class="@error('title') is-invalid @enderror">
      ...
      <div class="form-group">
        ...
        <input id="price" name="price" type="number" min="0" step="0.01" placeholder="Prezzo qui" class="d-block" class="@error('price') is-invalid @enderror">
      ...
      <div class="form-group">
        ...
        <textarea name="description" rows="8" cols="50" class="d-block" class="@error('description') is-invalid @enderror"></textarea>
      ...
      <div class="form-group">
        ...
        <input id="artist" name="artist" type="text" placeholder="Disegnatore qui" class="d-block" class="@error('description') is-invalid @enderror">
      ...
      <div class="form-group">
        ...
        <input id="writer" name="writer" type="text" placeholder="Scrittore qui" class="d-block" class="@error('writer') is-invalid @enderror">
      ...
      <div class="form-group">
        ...
        <input id="series" name="series" type="text" placeholder="Nome serie qui" class="d-block" class="@error('series') is-invalid @enderror">
      ...
      <div class="form-group">
        ...
        <input id="volume" name="volume" type="number" placeholder="Numero di uscita qui" class="d-block" min="0" class="@error('volume') is-invalid @enderror">
      ...
      <div class="form-group">
        ...
        <input id="trim_size" name="trim_size" type="text" placeholder="Dimensioni qui" class="d-block" class="@error('trim_size') is-invalid @enderror">
      ...
      <div class="form-group">
        ...
        <input id="pages" name="pages" type="number" placeholder="Numero di pagine qui" class="d-block" min="0" class="@error('pages') is-invalid @enderror">
      ...
      <div class="form-group">
        ...
        <input id="rated" name="rated" type="text" placeholder="Classificazione qui" class="d-block" class="@error('rated') is-invalid @enderror">
